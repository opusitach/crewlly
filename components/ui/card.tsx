...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        // HIG elevated surface: rounded-xl, subtle border, elev-1 shadow
        'bg-card text-card-foreground flex flex-col gap-4 rounded-xl border border-border py-5 shadow-elev-1',
        className,
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('text-headline leading-snug', className)}
      {...props}
    />
  )
}
